function pic(seed, w, h) {
  return "url('https://picsum.photos/seed/".concat(seed, "/").concat(w, "/").concat(h, "'), linear-gradient(135deg,#FF6B35,#FFAB40)");
}
function picG(seed, w, h, c1, c2) {
  return "url('https://picsum.photos/seed/".concat(seed, "/").concat(w, "/").concat(h, "'), linear-gradient(135deg,").concat(c1, ",").concat(c2, ")");
}
const SVG = {
  // 分类图标
...
const NEWEST_POSTS = [
  {
    user: "川味坊官方",
    userSvg: SVG.food,
    userBg: "linear-gradient(135deg,#FF6B35,#FF9A56)",
    time: "2小时前",
    isOfficial: true,
    images: [picG("newfood1a", 300, 200, "#FF6B35", "#FFAB40"), picG("newfood1b", 300, 200, "#FF7043", "#FFAB91")],
    imgCount: "two",
    title: "新品上市！招牌藤椒鱼双人餐",
  ...
  },
  {
    user: "松鹤楼SPA",
    userSvg: SVG.massage,
    userBg: "linear-gradient(135deg,#34C759,#30D158)",
    time: "3小时前",
    isOfficial: true,
    images: [picG("newspa1", 400, 250, "#66BB6A", "#AED581")],
    imgCount: "one",
    title: "新项目！泰式草药热敷SPA",
  ...
  {
    user: "锐力健身",
    userSvg: SVG.dumbbell,
    userBg: "linear-gradient(135deg,#FF2D55,#FF6B6B)",
    time: "5小时前",
    isOfficial: false,
    images: [picG("newfit1a", 200, 150, "#EF5350", "#FF8A80"), picG("newfit1b", 200, 150, "#FF2D55", "#FF6B6B"), picG("newfit1c", 200, 150, "#EC407A", "#F48FB1")],
    imgCount: "three",
  ...
  },
  {
    user: "欢乐KTV",
    userSvg: SVG.mic,
    userBg: "linear-gradient(135deg,#5856D6,#7B79F0)",
    time: "6小时前",
    isOfficial: true,
    images: [picG("newktv1a", 300, 200, "#5856D6", "#7B79F0"), picG("newktv1b", 300, 200, "#AB47BC", "#CE93D8")],
    imgCount: "two",
    title: "欢唱夜 · 新品套餐上线",
  ...
  },
  {
    user: "海世界餐厅",
    userSvg: SVG.star,
    userBg: "linear-gradient(135deg,#007AFF,#5AC8FA)",
    time: "8小时前",
    isOfficial: true,
    images: [picG("newsea1a", 300, 200, "#007AFF", "#5AC8FA"), picG("newsea1b", 300, 200, "#42A5F5", "#90CAF9")],
    imgCount: "two",
    title: "上新！波龙海鲜大餐双人套餐",
  ...
  },
  {
    user: "欢乐谷",
    userSvg: SVG.camera,
    userBg: "linear-gradient(135deg,#FF9500,#FFB800)",
    time: "12小时前",
    isOfficial: true,
    images: [picG("newpark1a", 300, 200, "#FF9500", "#FFB800"), picG("newpark1b", 300, 200, "#FFA726", "#FFCC80"), picG("newpark1c", 300, 200, "#FFB300", "#FFE082")],
    imgCount: "three",
...
function reminderIcon(type) {
  return (REMINDER_TYPES[type] || REMINDER_TYPES.custom).icon;
}
function reminderBg(type) {
  return (REMINDER_TYPES[type] || REMINDER_TYPES.custom).bg;
}
const REMINDERS = [
  {
    id: 1,
