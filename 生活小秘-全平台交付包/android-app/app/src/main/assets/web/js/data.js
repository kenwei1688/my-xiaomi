...
const FUNC_ITEMS = [
    ...
    { name:'我的足迹', svg:SVG.clock, bg:'linear-gradient(135deg,#007AFF,#5AC8FA)' },
    ...
    { name:'会员中心', svg:SVG.crown, bg:'linear-gradient(135deg,#5856D6,#7B79F0)' },
    { name:'附近门店', svg:SVG.store, bg:'linear-gradient(135deg,#00C7BE,#30D5C8)' },
    { name:'在线客服', svg:SVG.headset, bg:'linear-gradient(135deg,#AF52DE,#D65BFF)' },
];

// ===== 系统设置 =====
const SETTINGS = [
    { svg:SVG.bell, bg:'linear-gradient(135deg,#007AFF,#5AC8FA)', label:'消息通知', value:'' },
    { svg:SVG.pin, bg:'linear-gradient(135deg,#34C759,#30D158)', label:'收货地址管理', value:'3个地址' },
