...
const db = {
  ...
  functions: [
    ...
    { id: 2, name: '我的地址', icon: 'pin' },
    { id: 3, name: '优惠券', icon: 'ticket', count: 5 },
    { id: 4, name: '钱包余额', icon: 'wallet' },
    { id: 5, name: '积分商城', icon: 'gift' },
    { id: 6, name: '会员权益', icon: 'crown' },
    { id: 7, name: '我的关注', icon: 'store' },
    { id: 8, name: '在线客服', icon: 'headset' },
  ],

  // ===== 设置列表 =====
  settings: [
    { id: 1, name: '收货地址管理', icon: 'pin' },
    { id: 2, name: '消息通知设置', icon: 'bell' },
    { id: 3, name: '账户与安全', icon: 'lock' },
    { id: 4, name: '隐私设置', icon: 'gear' },
    { id: 5, name: '帮助与反馈', icon: 'question' },
    { id: 6, name: '关于我们', icon: 'info' },
  ],
